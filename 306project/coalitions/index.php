...
<body>
    <div id="outerdiv">
    <h1 class="heading">List of Coalitions</h1>
        <div id="innerdiv"> 
            <table id="table">
            <tr id="otr">
                <th class= "spec">coalition id</th>
                <th class= "spec">Coalition Name</th>
            </tr>
                <?php 

                include "config.php"; // Makes mysql connection

                $sql_statement = "SELECT * FROM coalitions"; 
                ...
                while($row = mysqli_fetch_assoc($result)) { // Iterating the result
                    ...
                    if($Coal_ID != 0)
                    {
                    echo "<tr>"."<th>" . $Coal_ID . "</th>". "<th>". $Name . "</th>"."</tr>";
                    }
                } 
                ?>
            </table>
